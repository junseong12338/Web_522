...
<body>
  ...
  <div class="reservation-form">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <form id="reservation-form" name="gs" method="post" role="search" action="/community/register">
            <div class="row">
              <div class="col-lg-12">
                <h4>소모임 작성</h4>
              </div>
              <div class="col-lg-6">
                  <fieldset>
                      ...
                      <input type="text" name='user_id' class="form-control" placeholder="사용자명" autocomplete="on" required>
                  </fieldset>
              </div>
              <div class="col-lg-6">
                <fieldset>
                    <label for="Title" class="form-label">소모임 제목</label>
                    <input type="text" class="form-control" name='community_title' placeholder="소모임 제목" autocomplete="on" required>
                </fieldset>
              </div>
              <div class="col-lg-6">
                  <fieldset>
              ...
              <div class="col-lg-6">
                <fieldset>
                    ...
                    <input type="date" name="community_schedule" class="form-control" id="community_schedule" required>
                </fieldset>
              </div>
              <div class="col-lg-6">
                <fieldset>
                    <label for="address" class="form-label">소모임 장소</label>
                    <input type="text" name="community_place" class="form-control" placeholder="소모임 장소" autocomplete="on" required>
                </fieldset>
              </div>
              <div class="col-lg-6">
                <fieldset>
                    <label for="address" class="form-label">좌표</label>
                    <input type="text" name="community_map" class="form-control" placeholder="좌표" autocomplete="on">
                </fieldset>
              </div>
              <div class="col-lg-12">
                  <fieldset>
