	...
	<header class="bg-dark py-5">
		...
		<div class="container px-4 px-lg-5 my-5">
			<div class="text-center text-white">
				...
				<p class="lead fw-normal text-white-50 mb-0">With this Prototype
					Website</p>
			</div>
		</div>
	</header>
			...
			<div class="list-group list-group-flush">
				<div class="flex-shrink-0 p-5 " style="width: 270px; height: 50px;">
					...
					<a href="#"
						...
						<svg class="bi pe-none me-2" width="30" height="24">
							<use xlink:href="#bootstrap" /></svg> <span class="fs-5 fw-semibold">필터
					</span> &nbsp;&nbsp; <span class="btn btn-outline-dark btn-sm mt-auto">적용</span>
					</a>
					<ul class="list-unstyled ps-0">
						<li class="mb-1">
							<button
								class="btn btn-toggle d-inline-flex align-items-center rounded border-0 collapsed"
								data-bs-toggle="collapse" data-bs-target="#dashboard-collapseㅇ"
								aria-expanded="false">나이대</button>
							<div class="collapse" id="dashboard-collapseㅇ">
								<ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
									<li></li>
									<li><a href="#"
										class="link-body-emphasis d-inline-flex text-decoration-none rounded">10대
											&nbsp;&nbsp; <input class="form-check-input" type="checkbox"
											id="checkboxNoLabel2" value="" />
									</a></li>
									<li><a href="#"
										class="link-body-emphasis d-inline-flex text-decoration-none rounded">20대
											&nbsp;&nbsp; <input class="form-check-input" type="checkbox"
											id="checkboxNoLabel2" value="" />
									</a></li>
									<li><a href="#"
										class="link-body-emphasis d-inline-flex text-decoration-none rounded">30대
											&nbsp;&nbsp; <input class="form-check-input" type="checkbox"
											id="checkboxNoLabel2" value="" />
									</a></li>
								</ul>
						...
						<li class="mb-1">
							<button
								...
								aria-expanded="false">test1</button>
